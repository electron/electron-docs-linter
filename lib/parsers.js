...
module.exports = {
  ...
  parameters: ($, openingHeadingElement) => {
        ...
        if (arg.type === 'Object') {
          ...
          arg.properties = $(el)
            ...
            .map((i, el) => {
              ...
              if (!match) return this.api.addError('parameter subproperties', parameterPattern, $(el).html())
              return {
                name: match[1],
                type: match[2],
                description: match[3]
        ...
        if (arg.type === 'String') {
          arg.possibleValues = $(el)
            ...
            .map((i, el) => {
              ...
              if (!match) return this.api.addError('parameter ENUM values', enumPattern, $(el).html())
              return {
                value: match[1],
                description: match[2]
              }
