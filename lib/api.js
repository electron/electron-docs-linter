...
class API {
  constructor (props, docs) {
    ...
    this.instanceMethods = require('./api/methods')(this, 'h2#instance-methods')
    this.events = require('./api/events')(this)

    // Attach named keys to arrays for easier traversal
    // e.g. apis.BrowserWindow.instanceMethods.setContentSize
    this.instanceMethods.forEach(method => {
      this.instanceMethods[method.name] = method
    })

    // e.g. apis.app.events.quit
